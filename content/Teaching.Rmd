...
```{r cache=FALSE, collapse=TRUE, results='asis', echo=FALSE}
knitr::kable(spring.19.q1, caption = "Spring 2019 Student Evaluations, Statistics Lab") %>% 
  kableExtra::kable_styling(position = "left")

knitr::kable(spring.19.q2.q12) %>% 
  kableExtra::kable_styling(position = "left")
knitr::kable(spring.19.q13) %>% 
  kableExtra::kable_styling(position = "left")
knitr::kable(spring.19.q14) %>% 
  kableExtra::kable_styling(position = "left")
knitr::kable(spring.19.q15) %>% 
  kableExtra::kable_styling(position = "left")
knitr::kable(spring.19.q16) %>% 
  kableExtra::kable_styling(position = "left")
knitr::kable(spring.19.q17) %>% 
  kableExtra::kable_styling(position = "left")
knitr::kable(spring.19.q19.q23) %>% 
  kableExtra::kable_styling(position = "left")
```
</div>
