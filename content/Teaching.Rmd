...
![<i>Raphael. “The school of athens”. Circa 1510. Fresca. Stanze di Raffaello, in the Apostolic Palace in the Vatican.</i>](/img/athens.jpg){style="border-radius: 2%; opacity:0.9; filter:grayscale(25%)"}
   ...
   <ul>
     <li><a href="#Courses">Courses Taught</a>
		 <ol>
			...
			<li><a href="#Summer19">Summer 2019</a></li>
...
onclick=window.open('https://matthewevanaman.netlify.app//PDFs/eval_spring19.pdf','_blank')
