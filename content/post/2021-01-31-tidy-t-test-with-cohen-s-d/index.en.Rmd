...
This output gives you everything, clearly labeled, with our friend Cohen's $d$ included. The \$d\$ measure of effect size is quite large (1.53), which is about twice the size of the cutoff for a "large" effect size.
