...
Effect sizes help contextualize the results of statistical tests, which consensus is more often beginning to recognize as the least interesting part of statistical output ([Sullivan & Feinn, 2012](#ref-sullivan2012using)). Indeed, researchers have been pressured to report measures of effect size alongside descriptive and inferential statistics in their published work for about two decades now ([Coe, 2002](#ref-coe2002effect)). As most introductory statistics courses will teach, Cohen’s \$d\$ follows some rules of thumb that help give a sense of how impressive the magnitude of the mean difference is ([Cohen, 2013](#ref-cohen2013statistical)):
...
Coe, R. (2002). *It’s the effect size, stupid: What effect size is and why it is important*. [Full Text](http://www.leeds.ac.uk/educol/documents/00002182.htm)

</div>

<div id="ref-cohen2013statistical" class="csl-entry">

Cohen, J. (2013). *Statistical power analysis for the behavioral sciences*. Academic press. [Full Text](https://books.google.com/books?hl=en&lr=&id=rEe0BQAAQBAJ&oi=fnd&pg=PP1&dq=Statistical+power+analysis+for+the+behavioral+sciences.&ots=swUSKrRTu8&sig=RqINXdX_uJjD_mB6UerWX-JBgVg#v=onepage&q=Statistical%20power%20analysis%20for%20the%20behavioral%20sciences.&f=false)

</div>

<div id="ref-sullivan2012using" class="csl-entry">

Sullivan, G. M., & Feinn, R. (2012). Using effect size—or why the p value is not enough. *Journal of Graduate Medical Education*, *4*(3), 279. [Full Text](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3444174/)
